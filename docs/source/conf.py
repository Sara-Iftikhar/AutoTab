...
sphinx_gallery_conf = {
    ...
    'examples_dirs': os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))),
                                  'examples'),
    ...
    'binder': {'org': 'sphinx-gallery',
               ...
               'dependencies': os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))),
